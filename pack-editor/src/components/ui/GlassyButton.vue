...
<template>
  <component
    ...
    :disabled="disabled"
    :class="[
      'px-6 py-3 text-sm font-bold text-white bg-white/10 rounded-xl',
  ...
  >
    ...
    <div class="absolute inset-0 bg-gradient-to-r from-[hsl(var(--teal-500))]/20 via-[hsl(var(--teal-500))]/10 to-[hsl(var(--teal-500))]/20 opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
