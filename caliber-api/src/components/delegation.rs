...
use crate::types::delegation::{CreateDelegationRequest, DelegationResponse};
...
impl_component! {
    DelegationResponse {
        ...
        not_found_error: |id| ApiError::entity_not_found("Delegation", id),
    }
}
...
pub struct DelegationListFilter {
    ...
    pub delegator_agent_id: Option<EntityId>,
