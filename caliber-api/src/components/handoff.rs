...
use crate::types::handoff::{CreateHandoffRequest, HandoffResponse};
...
impl_component! {
    HandoffResponse {
        ...
        not_found_error: |id| ApiError::entity_not_found("Handoff", id),
    }
}
