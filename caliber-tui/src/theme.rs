...
pub fn trajectory_status_color(theme: &SynthBruteTheme, status: TrajectoryStatus) -> Color {
    match status {
        TrajectoryStatus::Active => theme.primary,
        TrajectoryStatus::Completed => theme.success,
        TrajectoryStatus::Failed => theme.error,
...
pub fn agent_status_color(theme: &SynthBruteTheme, status: &str) -> Color {
...
pub fn message_priority_color(theme: &SynthBruteTheme, priority: &str) -> Color {
...
pub fn turn_role_color(theme: &SynthBruteTheme, role: TurnRole) -> Color {
    match role {
        TurnRole::User => theme.primary,
        TurnRole::Assistant => theme.secondary,
        TurnRole::System => theme.tertiary,
...
pub fn utilization_color(theme: &SynthBruteTheme, utilization: f32) -> Color {
    if utilization < 70.0 {
        theme.success
